 ...
 */
    ...
    'filled-request' => '已帮忙',
    'follow' => '关注',
    'follow-already' => '你已经在关注此用户',
    'follow-not-to-begin-with' => '你一开始就没有关注此用户',
    'follow-revoked' => '你不再关注 %s',
    'follow-user' => '你现在正在关注 %s',
    'follow-yourself' => '不错的尝试，但遗憾的是你不能关注自己。',
    ...
    'followers' => '粉丝',
    'following' => '正在关注',
    'following-notification' => '关注通知设定',
    'following-notification-upload' => '当你所关注的人发布了资源，发出一个通知',
    'following-notification-help' => '调整你所关注的人相关的通知设定。
    若不勾选任何触发用户组，或你已<strong>取消全局性</strong>通知，以下设定将会无效。',
    ...
    'information' => '资讯',
    'invited-by' => '来源',
    'invite-already-sent' => '您尝试向其发送邀请的电子邮件地址已经发送过。',
    'invite-already-used' => '您尝试重新发送的邀请已被使用。',
    'invite-expired' => '您尝试重新发送的邀请已过期。',
    'invite-friend' => '邀请你的朋友（需要 邮箱 + 资料）',
    'invite-resent-success' => '邀请已成功重新发送！',
    ...
    'invites-disabled-group' => '您的用户组当前已禁用邀请。',
    'invites-rules' => [
        'know-and-trust' => '只邀请那些你信得过及了解的朋友。',
        'responsible' => '你需要对这些邀请负个人责任。',
        'yourself' => '不准使用马甲。',
        'trade-or-sell' => '不准买卖邀请码。',
        'caught' => '若你所邀请的人因作弊或买卖帐户而被封禁，你也会被牵连。',
        'responsibile' => '你将对邀请的人承担相应责任。',
    ],
    'invites-send' => '邀请已发送',
    'judge' => '审核人',
    'last-login' => '上次登录时间',
    ...
    若已<strong>取消全局性</strong>通知，以下设定将会无效。',
    'notification-from-following' => '收取来自关注你的通知',
    'notification-from-following-help' => '只从系统，管理员及以下勾选的用户组收取关注你的通知。
    若已<strong>取消全局性</strong>通知，以下设定将会无效。',
    ...
    'seedbox-added-success' => 'Seedbox已成功添加！',
    'seedbox-deleted-success' => 'Seedbox已成功删除',
    'seedboxes' => 'Seedbox',
    'seeding-size' => '做种体积',
    'seeds' => '做种',
    'send-invite' => '寄出邀请',
    ...
    'warning-log' => '警告日志',
    'wishlist' => '愿望清单',
    'homepage-block-random-media-visible' => '显示随机媒体版块',
    'homepage-block-top-torrents-visible' => '显示顶级种子版块',
    'homepage-block-top-users-visible' => '显示顶级用户版块',
    'internal-releases' => '官方发布组',
    'my-downloads' => '我的下载',
    'my-playlists' => '我的播放列表',
    'password-resets' => '密码重置',
    'rsskey' => 'RSS密钥',
    'rsskeys' => 'RSS密钥',
    'total-internal-releases' => '官方组发布总数',
    'total-personal-releases' => '个人发布总数',
    'two-step-auth' => [
        'title' => '二次验证',
        'totp' => '基于时间的一次性密码（动态验证码）认证',
        'email' => '电子邮件认证',
        'totp-is-enabled' => '当前启用了动态身份验证。要禁用它，请点击下面的“禁用”按钮。',
        'totp-is-disabled' => '动态身份验证当前被禁用。要启用它，请点击下面的“启用”按钮。',
        'password-confirm' => '需要确认密码',
    ...
    'apikey' => 'API密钥',
    'apikeys' => 'API密钥',
    'email-updates' => '电子邮件更新',
    'homepage-blocks' => '主页板块',
    'homepage-block-chat-visible' => '显示聊天框板块',
    'homepage-block-featured-visible' => '显示特色种子板块',
    'homepage-block-latest-comments-visible' => '显示最新评论板块',
    'homepage-block-latest-posts-visible' => '显示最新帖子板块',
    'homepage-block-latest-topics-visible' => '显示最新主题板块',
    ...
    'profile-is-private' => '个人资料设置为私密',
    'show-adult-content' => '在首页和种子搜索框中显示成人内容',
    'unregistered-info-hashes' => '未注册的哈希信息',
];
